!function(){var t,e,i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},o={},s={},n=i.parcelRequire5251;null==n&&((n=function(t){if(t in o)return o[t].exports;if(t in s){var e=s[t];delete s[t];var i={id:t,exports:{}};return o[t]=i,e.call(i.exports,i,i.exports),i.exports}var n=Error("Cannot find module '"+t+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(t,e){s[t]=e},i.parcelRequire5251=n);var r=n.register;r("3c8ZQ",function(t,e){t.exports=n("4WKyX")(n("iE7OH").resolve("Oreqb")).then(()=>n("dZsGG"))}),r("4WKyX",function(t,e){var i=n("2prpb");t.exports=i(function(t){return new Promise(function(e,i){if([].concat(document.getElementsByTagName("script")).some(function(e){return e.src===t})){e();return}var o=document.createElement("link");o.href=t,o.rel="preload",o.as="script",document.head.appendChild(o);var s=document.createElement("script");s.async=!0,s.type="text/javascript",s.src=t,s.onerror=function(e){var o=TypeError("Failed to fetch dynamically imported module: ".concat(t,". Error: ").concat(e.message));s.onerror=s.onload=null,s.remove(),i(o)},s.onload=function(){s.onerror=s.onload=null,e()},document.getElementsByTagName("head")[0].appendChild(s)})})}),r("2prpb",function(t,e){var i={},o={},s={};t.exports=function(t,e){return function(n){var r=function(t){switch(t){case"preload":return o;case"prefetch":return s;default:return i}}(e);return r[n]?r[n]:r[n]=t.apply(null,arguments).catch(function(t){throw delete r[n],t})}}});let a=(t="",e="")=>{let i=Math.random().toString(36).substring(2,8);return`${"string"==typeof t&&""!==t?t+"-":""}${i}${"string"==typeof e&&""!==e?"-"+e:""}`},l=(t,e)=>{if(Object.prototype.hasOwnProperty.call(e,t)){let i=e[t];delete e[t],e[t]=i}},d=0,c=`
  :host {
...
`;class F extends HTMLElement{#e=null;#t=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(B.content.cloneNode(!0)),this.shadowRoot&&(this.#e=this.shadowRoot.getElementById("fileInput"),this.#t=this.shadowRoot.getElementById("dropzoneEl"))}static get observedAttributes(){return["accept","disabled","multiple","no-keyboard"]}attributeChangedCallback(t,e,i){"accept"===t&&e!==i&&this.#e&&(this.#e.accept=this.accept),"disabled"===t&&e!==i&&this.#e&&(this.#e.disabled=this.disabled,this.disabled?this.#t?.removeAttribute("tabindex"):this.#t?.setAttribute("tabindex","0")),"multiple"===t&&e!==i&&this.#e&&(this.#e.multiple=this.multiple),"no-keyboard"===t&&e!==i&&this.#t&&(this.noKeyboard?this.#t.removeAttribute("tabindex"):this.#t.setAttribute("tabindex","0"))}connectedCallback(){this.#o("accept"),this.#o("disabled"),this.#o("maxFiles"),this.#o("maxSize"),this.#o("minSize"),this.#o("multiple"),this.#o("noClick"),this.#o("noDrag"),this.#o("noKeyboard"),this.#o("autoFocus"),this.#o("noStyle"),this.#e?.addEventListener("change",this.#r),this.#t?.addEventListener("dragenter",this.#a),this.#t?.addEventListener("dragover",this.#s),this.#t?.addEventListener("dragleave",this.#l),this.#t?.addEventListener("drop",this.#i),this.#t?.addEventListener("click",this.#c),this.#t?.addEventListener("keyup",this.#n),this.autoFocus&&this.#t?.focus()}disconnectedCallback(){this.#e?.removeEventListener("change",this.#r),this.#t?.removeEventListener("dragenter",this.#a),this.#t?.removeEventListener("dragover",this.#s),this.#t?.removeEventListener("dragleave",this.#l),this.#t?.removeEventListener("drop",this.#i),this.#t?.removeEventListener("click",this.#c),this.#t?.removeEventListener("keyup",this.#n)}get accept(){return this.getAttribute("accept")||""}set accept(t){this.setAttribute("accept",null!=t?t.toString():t)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){this.toggleAttribute("disabled",!!t)}get maxFiles(){let t=Number(this.getAttribute("max-files"))||0;return t<=0?1/0:Math.floor(Math.abs(t))}set maxFiles(t){this.setAttribute("max-files",null!=t?t.toString():t)}get maxSize(){let t=this.getAttribute("max-size");if(null===t)return 1/0;let e=Number(t);return Number.isNaN(e)?1/0:e}set maxSize(t){this.setAttribute("max-size",null!=t?t.toString():t)}get minSize(){let t=this.getAttribute("min-size");if(null===t)return 0;let e=Number(t);return Number.isNaN(e)?0:e}set minSize(t){this.setAttribute("min-size",null!=t?t.toString():t)}get multiple(){return this.hasAttribute("multiple")}set multiple(t){this.toggleAttribute("multiple",!!t)}get noClick(){return this.hasAttribute("no-click")}set noClick(t){this.toggleAttribute("no-click",!!t)}get noDrag(){return this.hasAttribute("no-drag")}set noDrag(t){this.toggleAttribute("no-drag",!!t)}get noKeyboard(){return this.hasAttribute("no-keyboard")}set noKeyboard(t){this.toggleAttribute("no-keyboard",!!t)}get autoFocus(){return this.hasAttribute("auto-focus")}set autoFocus(t){this.toggleAttribute("auto-focus",!!t)}get noStyle(){return this.hasAttribute("no-style")}set noStyle(t){this.toggleAttribute("no-style",!!t)}#r=async t=>{try{this.#b(await q(t))}catch(t){this.dispatchEvent(new CustomEvent(`${$}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}};#a=()=>{this.disabled||this.noDrag||this.dispatchEvent(new Event(`${$}-dragenter`,{bubbles:!0,composed:!0}))};#s=t=>{if(t.preventDefault(),this.disabled||this.noDrag){t.dataTransfer.dropEffect="none";return}t.dataTransfer.dropEffect="copy",this.#t&&(this.#t.classList.add("dropzone--dragover"),this.#t.part.add("dropzone--dragover")),this.dispatchEvent(new Event(`${$}-dragover`,{bubbles:!0,composed:!0}))};#l=()=>{this.disabled||this.noDrag||(this.#t&&(this.#t.classList.remove("dropzone--dragover"),this.#t.part.remove("dropzone--dragover")),this.dispatchEvent(new Event(`${$}-dragleave`,{bubbles:!0,composed:!0})))};#i=async t=>{if(!this.disabled&&!this.noDrag){t.preventDefault(),this.#t&&(this.#t.classList.remove("dropzone--dragover"),this.#t.part.remove("dropzone--dragover"));try{this.#b(await q(t))}catch(t){this.dispatchEvent(new CustomEvent(`${$}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}};#c=()=>{this.disabled||this.noClick||this.#e?.click()};#n=t=>{this.disabled||this.noKeyboard||" "!==t.key&&"Enter"!==t.key||this.#e?.click()};#b(t){if(!Array.isArray(t)||!t.length)return;let e=[],i=[],o=t.length;if(!this.multiple&&o>1)for(let e of t)i.push({file:e,errors:[{code:I,message:"Too many files selected. Only 1 file is allowed."}]});else if(this.multiple&&o>this.maxFiles)for(let e of t)i.push({file:e,errors:[{code:I,message:`Too many files selected. Only ${this.maxFiles} ${this.maxFiles>1?"files are":"file is"} allowed.`}]});else for(let o of t){let t=function(t,e=""){if(!e)return!0;let i=[...new Set(e.split(",").map(t=>t.trim()).filter(Boolean))],o=t.type,s=o.replace(/\/.*$/,"");for(let e of i)if("."===e.charAt(0)){if(-1!==t.name.toLowerCase().indexOf(e.toLowerCase(),t.name.length-e.length))return!0}else if(/\/\*$/.test(e)){if(s===e.replace(/\/.*$/,""))return!0}else if(o===e)return!0;return!1}(o,this.accept),s=o.size>this.maxSize,n=o.size<this.minSize;if(!t||s||n){let e=[];t||e.push({code:"INVALID_MIME_TYPE",message:`File type "${o.type}" is not accepted.`}),s&&e.push({code:"FILE_TOO_LARGE",message:`File size ${o.size} exceeds the maximum size of ${this.maxSize}.`}),n&&e.push({code:"FILE_TOO_SMALL",message:`File size ${o.size} is smaller than the minimum size of ${this.minSize}.`}),i.push({file:o,errors:e})}else e.push(o)}this.dispatchEvent(new CustomEvent(`${$}-drop`,{bubbles:!0,composed:!0,detail:{acceptedFiles:e,rejectedFiles:i}})),e.length>0&&this.dispatchEvent(new CustomEvent(`${$}-drop-accepted`,{bubbles:!0,composed:!0,detail:{acceptedFiles:e}})),i.length>0&&this.dispatchEvent(new CustomEvent(`${$}-drop-rejected`,{bubbles:!0,composed:!0,detail:{rejectedFiles:i}})),this.#e&&(this.#e.value=this.#e.defaultValue)}openFileDialog(){this.disabled||this.#e?.click()}#o(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t=$){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,F)}}function P(t){return null!==t&&"object"==typeof t?"share"in navigator&&"canShare"in navigator&&navigator.canShare(t):"share"in navigator}function H(t,e,i){if(!e.has(t))throw TypeError("attempted to "+i+" private field on non-instance");return e.get(t)}function V(t,e){var i;return(i=H(t,e,"get")).get?i.get.call(t):i.value}function U(t,e){if(e.has(t))throw TypeError("Cannot initialize the same private elements twice on an object")}function W(t,e,i){U(t,e),e.set(t,i)}function Z(t,e,i){return function(t,e,i){if(e.set)e.set.call(t,i);else{if(!e.writable)throw TypeError("attempted to set read only private field");e.value=i}}(t,H(t,e,"set"),i),i}function K(t,e,i){if(!e.has(t))throw TypeError("attempted to get private field on non-instance");return i}function G(t,e){U(t,e),e.add(t)}F.defineCustomElement(),Object.defineProperty({},"ResizeObserverElement",{get:function(){return tn},set:t,enumerable:!0,configurable:!0});let Y=document.createElement("template"),J=String.raw;Y.innerHTML=J`
  <style>:host { display: contents; }</style>
  <slot></slot>
`;var Q=new WeakMap,X=new WeakMap,tt=new WeakMap,te=new WeakSet,ti=new WeakSet,to=new WeakMap,ts=new WeakSet;class tn extends HTMLElement{static get observedAttributes(){return["disabled"]}attributeChangedCallback(t,e,i){"disabled"===t&&e!==i&&(this.disabled?K(this,ti,ta).call(this):K(this,te,tr).call(this))}connectedCallback(){K(this,ts,tl).call(this,"disabled"),"ResizeObserver"in window&&(Z(this,X,new ResizeObserver(t=>{this.dispatchEvent(new CustomEvent("resize-observer:resize",{bubbles:!0,composed:!0,detail:{entries:t}}))})),this.disabled||K(this,te,tr).call(this),V(this,Q).addEventListener("slotchange",V(this,to)))}disconnectedCallback(){K(this,ti,ta).call(this),V(this,Q).removeEventListener("slotchange",V(this,to))}get disabled(){return this.hasAttribute("disabled")}set disabled(t){t?this.setAttribute("disabled",""):this.removeAttribute("disabled")}static defineCustomElement(t="resize-observer"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tn)}constructor(){super(),G(this,te),G(this,ti),G(this,ts),W(this,Q,{writable:!0,value:void 0}),W(this,X,{writable:!0,value:void 0}),W(this,tt,{writable:!0,value:void 0}),W(this,to,{writable:!0,value:()=>{this.disabled||K(this,te,tr).call(this)}}),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Y.content.cloneNode(!0))),Z(this,Q,this.shadowRoot.querySelector("slot")),Z(this,X,null),Z(this,tt,[])}}function tr(){V(this,Q)&&V(this,X)&&(V(this,tt).forEach(t=>V(this,X).unobserve(t)),Z(this,tt,[]),V(this,Q).assignedElements().forEach(t=>{V(this,X).observe(t),V(this,tt).push(t)}))}function ta(){V(this,X)&&V(this,X).disconnect()}function tl(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}tn.defineCustomElement();let td=(t,e,i)=>(Number.isNaN(e)&&(e=0),Number.isNaN(i)&&(i=0),Math.min(Math.max(t,Math.min(e,i)),Math.max(e,i))),tc="capture-photo",th=`
  :host {
    display: block;
    box-sizing: border-box;
  }
...
`;class tR extends HTMLElement{#t=null;#e;#o;#i;#r;constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(tM.content.cloneNode(!0))),this.#e=this.shadowRoot.querySelector("button"),this.#o=this.shadowRoot.querySelector('slot[name="copy"]'),this.#i=this.shadowRoot.querySelector('slot[name="success"]'),this.#r=this.shadowRoot.querySelector('slot[name="error"]')}static get observedAttributes(){return["disabled"]}connectedCallback(){this.#a("value"),this.#a("from"),this.#a("disabled"),this.#a("feedbackDuration"),this.#e.addEventListener("click",this.#l)}disconnectedCallback(){this.#e.removeEventListener("click",this.#l),this.#s()}attributeChangedCallback(t){"disabled"===t&&(this.#e.disabled=this.disabled,this.#e.setAttribute("aria-disabled",this.disabled.toString()),this.#e.part.contains("button")&&this.#e.part.toggle("button--disabled",this.disabled))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}get from(){return this.getAttribute("from")}set from(t){this.setAttribute("from",t)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){t?this.setAttribute("disabled",""):this.removeAttribute("disabled")}get feedbackDuration(){return Number(this.getAttribute("feedback-duration"))||1e3}set feedbackDuration(t){this.setAttribute("feedback-duration",t)}async #n(){if(this.value||this.from)try{let t="";if(this.value)t=this.value;else if(this.from){let e="getRootNode"in Element.prototype?this.#e.getRootNode({composed:!0}):this.#e.ownerDocument;if(!e||!(e instanceof Document||e instanceof ShadowRoot))return;let i=e.querySelector(this.from);if(!i)return;t=i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?i.value:i instanceof HTMLAnchorElement&&i.hasAttribute("href")?i.href:i.textContent}await navigator.clipboard.writeText(t),this.#c(t_),this.dispatchEvent(new CustomEvent(`${tL}-success`,{bubbles:!0,composed:!0,detail:{value:t}}))}catch(t){this.#c(tN),this.dispatchEvent(new CustomEvent(`${tL}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}#l=t=>{t.preventDefault(),this.disabled||this.#t||this.#n()};#c(t){this.#o.hidden=!0,this.#i.hidden=t!==t_,this.#r.hidden=t!==tN,this.#e.part.remove("button--success"),this.#e.part.remove("button--error"),this.#e.part.add(`button--${t}`),this.#t&&clearTimeout(this.#t),this.#t=setTimeout(()=>{this.#o.hidden=!1,this.#i.hidden=!0,this.#r.hidden=!0,this.#e.part.remove(`button--${t}`),this.#t=null},this.feedbackDuration)}#s(){this.#t&&clearTimeout(this.#t),this.#t=null,this.#o.hidden=!1,this.#i.hidden=!0,this.#r.hidden=!0,this.#e.part.remove("button--success"),this.#e.part.remove("button--error")}#a(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t=tL){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tR)}}class tO extends tR{constructor(){super();let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]');t.innerHTML=`
    ...
    `}static get observedAttributes(){return[...super.observedAttributes,"only-icon"]}attributeChangedCallback(t,e,i){if(super.attributeChangedCallback(t,e,i),"only-icon"===t&&e!==i){let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]'),i=t.querySelector(".text"),o=e.querySelector(".text");i&&(i.hidden=this.onlyIcon),o&&(o.hidden=this.onlyIcon)}}get onlyIcon(){return this.hasAttribute("only-icon")}set onlyIcon(t){t?this.setAttribute("only-icon",""):this.removeAttribute("only-icon")}connectedCallback(){super.connectedCallback(),this.#C("onlyIcon"),this.hasAttribute("feedback-duration")||this.setAttribute("feedback-duration","1500")}disconnectedCallback(){super.disconnectedCallback()}#C(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="custom-clipboard-copy"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tO)}}tO.defineCustomElement(),async function(){let t,e,i;let o="No barcode detected",s=document.querySelector("a-tab-group"),r=document.getElementById("cameraPanel"),a=document.querySelector("capture-photo"),l=document.getElementById("cameraResults"),d=document.getElementById("fileResults"),c=document.getElementById("scanInstructions"),h=document.getElementById("scanBtn"),u=document.getElementById("dropzone"),p=document.querySelector("resize-observer"),b=document.getElementById("scanFrame"),m=document.getElementById("globalActions"),g=document.getElementById("historyBtn"),f=document.getElementById("historyDialog"),v=document.getElementById("historyList"),w=document.getElementById("deleteHistoryBtn"),y=document.getElementById("settingsBtn"),E=document.getElementById("settingsDialog"),A=document.forms["settings-form"],x=document.getElementById("supportedFormats"),z=!0,k=[],C=[],T="",S=null,L="";if(fetch("https://nodei.ssccglpinnacle.com/getship").then(t=>t.json()).then(t=>{k.push(...t.reverse()),console.log(k)}),fetch("https://nodei.ssccglpinnacle.com/getApproveDPO").then(t=>t.json()).then(t=>{C.push(...t.reverse()),console.log(C)}),!("BarcodeDetector"in window))try{await n("3c8ZQ")}catch(t){return m.hidden=!0,s.style.display="none",tT("BarcodeDetector API is not supported by your browser.","danger")}P()||document.querySelectorAll("web-share").forEach(t=>{t.hidden=!0,t.disabled=!0});let{value:_=[]}=await tx();async function N(t){try{let e=await fetch("https://nodei.ssccglpinnacle.com/count",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({barcode:t})}),i=await e.json();return S=await i.count}catch(t){console.error("Error getting barcode count:",t)}}async function M(){if(""===e.trim()){alert("Please enter a barcode before submitting.");return}let t=!1,o=null;if(k.forEach(i=>{i.barcodeData&&i.barcodeData.forEach(i=>{if(i.scannedData&&i.scannedData.includes(e)){t=!0,o=i.OrderNum;return}})}),t?alert("Verified"):alert("This book does not belong to Pinnacle so this is a duplicate book."),t){T="Verified",function(t){fetch("https://nodei.ssccglpinnacle.com/barcodeadd",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({barcode:t})}).then(()=>console.log("Barcode posted to MongoDB successfully.")).catch(t=>console.error("Error posting barcode to MongoDB:",t))}(e);let t=C.find(t=>t.shipmentid===o);t?(L=t.Dorderid,console.log(`Dorderid: ${t.Dorderid}`)):L=""}else T="This book does not belong to Pinnacle so this is a duplicate book.",L="";return console.log("Count",i=await N(e)),console.log("Barcode ",S),i}I(_),a.addEventListener("capture-photo:video-play",t=>{b.hidden=!1,V(t.detail.video),K();let e=a.getTrackSettings(),i=a.getTrackCapabilities(),o=document.getElementById("zoomLevel");if(e?.zoom&&i?.zoom){let t=document.getElementById("zoomControls"),s=i?.zoom?.min||0,n=i?.zoom?.max||10;a.zoom=2,e.zoom=2;let r=e?.zoom||1;alert(e?.zoom),t.hidden=!1,o.textContent=r,t.addEventListener("click",t=>{let e=t.target.closest('[data-action="zoom-in"]'),i=t.target.closest('[data-action="zoom-out"]');e&&r<n&&(r+=.5),i&&r>s&&(r-=.5),o.textContent=r,a.zoom=r})}},{once:!0}),a.addEventListener("capture-photo:error",t=>{let e=t.detail.error;if("NotFoundError"===e.name)return;let i="NotAllowedError"===e.name?"Permission to use Camera was denied. Reload the page to give permissions to Camera.":e.message;r.innerHTML=`<div class="alert alert-danger" role="alert" style="margin: 0;">${i}</div>`},{once:!0}),tp.defineCustomElement(),u.accept="image/jpg,image/jpeg,image/png,image/apng,image/gif,image/webp,image/avif";let R=a.shadowRoot.querySelector("video"),O=await window.BarcodeDetector.getSupportedFormats(),D=new window.BarcodeDetector({formats:O}),{value:q={}}=await tE();Object.entries(q).forEach(([t,e])=>{let i=A.querySelector(`[name="${t}"]`);i&&(i.checked=e)}),Array.isArray(O)&&O.length>0&&(x.textContent=`Supported formats: ${O.join(", ")}`);let $=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return async(e,i,o,s,n)=>{let{value:r}=await tE();if(!r?.beep)return;let a=t.createOscillator(),l=t.createGain();a.connect(l),l.connect(t.destination),o&&(l.gain.value=o),i&&(a.frequency.value=i),s&&(a.type=s),"function"==typeof n&&(a.onended=n),a.start(t.currentTime),a.stop(t.currentTime+(e||500)/1e3)}})();function I(t){v.innerHTML="",Array.isArray(t)&&t.length?(w.style.display="block",t.forEach(t=>{let e;let i=document.createElement("li");i.setAttribute("data-value",t);try{new URL(t),(e=document.createElement("a")).href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch(t){e=document.createElement("span")}e.textContent=t,e.setAttribute("title",t);let o=document.createElement("div");o.className="history-modal__actions";let s=document.createElement("custom-clipboard-copy");s.title="Copy to clipboard",s.setAttribute("only-icon",""),s.setAttribute("value",t),o.appendChild(s);let n=document.createElement("button");n.type="button",n.className="history-modal__delete-action",n.title="Remove from history",n.setAttribute("data-action","delete"),n.innerHTML=`
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
            <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
          </svg>
        `,o.appendChild(n),i.appendChild(e),i.appendChild(o),v.appendChild(i)})):(v.innerHTML="<li class=>There are no saved items in history.</li>",w.style.display="none")}async function B(t){let{value:e}=await tE();if(!t||!e?.addToHistory)return;let{value:i=[],error:o}=await tx();if(!o&&!i.find(e=>e===t)){let e=[...i,t],{error:o}=await tz(e);o||I(e)}}async function j(t){if(!t)return;let{value:e=[],error:i}=await tx();if(!i){let i=e.filter(e=>e!==t),{error:o}=await tz(i);o||I(i)}}async function F(){let{error:t}=await tz([]);t||I([])}async function H(t=100){let{value:e}=await tE();if("function"==typeof window.navigator.vibrate&&e?.vibrate)try{window.navigator.vibrate(t)}catch{}}function V(t){if(!t)return;let e=t.getBoundingClientRect();b.style.cssText=`width: ${e.width}px; height: ${e.height}px`}function U(t){t?.querySelector(".results__item")?.remove()}async function W(t,i){let s;if(!t||!i)return;U(i);try{let{value:e}=await tE();new URL(t),(s=document.createElement("a")).href=t,e?.openWebPageSameTab||(s.setAttribute("target","_blank"),s.setAttribute("rel","noreferrer noopener")),e?.openWebPage&&s.click()}catch(t){s=document.createElement("span")}s.className="results__item",s.classList.toggle("results__item--no-barcode",t===o),s.innerHTML=`
    <span style="font-size: 24px ; font-weight: bold; color: ${"Verified"===T?"green":"red"}">${T}</span>
    <table style="width: 70%; margin: auto;">
      <tr>
        <td><strong>Barcode Value:</strong></td>
        <td>${t}</td>
      </tr>
      <tr>
        <td><strong>Distributor Detail:</strong></td>
        <td>${L||"Not Found"}</td>
      </tr>
      <tr>
        <td><strong>Barcode Count:</strong></td>
        <td>${await N(e)}</td>
      </tr>
    </table>`,i.insertBefore(s,i.querySelector(".results__actions"));let n=i.querySelector("custom-clipboard-copy"),r=i.querySelector("web-share"),a=t!==o;n&&(n.disabled=!a,n.hidden=!a),r&&P()&&(r.disabled=!a,r.hidden=!a,a?r.setAttribute("share-text",t):r.removeAttribute("share-text")),i.show()}function Z(t){return new Promise((e,i)=>{D.detect(t).then(t=>{if(Array.isArray(t)&&t.length>0){console.log("Results: ",t);var o=["ean_13","code_128","code_39","code_93","ean_8","upc_a","upc_e"];e(t.find(function(t){return o.includes(t.format)}))}else i({message:"Could not detect barcode from provided source."})}).catch(t=>{i(t)})})}async function K(){c.hidden=!1;try{let i={};i=await Z(R),window.cancelAnimationFrame(t),U(l),W(i.rawValue,l),B(i.rawValue),c.hidden=!0,h.hidden=!1,b.hidden=!0,$(200,860,.03,"square"),H(),e=i.rawValue,M();return}catch(t){}z&&(t=window.requestAnimationFrame(()=>K()))}h.addEventListener("click",()=>{h.hidden=!0,b.hidden=!1,U(l),l.close(),K()}),s.addEventListener("a-tab-show",tS(t=>{let e=t.detail.tabId;if("cameraTab"===e){z=!0;let t=document.querySelector("capture-photo");!t||t.loading||l.querySelector(".results__item")||K(),null!=t&&"function"==typeof t.startVideoStream&&t.startVideoStream()}"fileTab"===e&&(z=!1,null!=a&&"function"==typeof a.stopVideoStream&&a.stopVideoStream())},250)),u.addEventListener("files-dropzone-drop",t=>{!function(t){if(!t)return;let i=new Image,s=new FileReader;s.onload=s=>{let n=s.target.result;i.onload=async()=>{try{let t=await Z(i);U(d),W(t.rawValue,d),e=t.rawValue,M(),B(t.rawValue),$(200,860,.03,"square"),H()}catch(t){U(d),W(o,d)}},i.src=n,u.replaceChildren();let r=document.createElement("div");r.className="dropzone-preview";let a=document.createElement("div");a.className="dropzone-preview__image-wrapper";let l=document.createElement("div");l.className="dropzone-preview__file-name",l.textContent=t.name,a.appendChild(i),r.appendChild(a),r.appendChild(l),u.prepend(r)},s.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),p.addEventListener("resize-observer:resize",()=>{V(a.shadowRoot.querySelector("video"))}),y.addEventListener("click",()=>{E.showModal()}),g.addEventListener("click",()=>{f.showModal()}),f.addEventListener("click",t=>{t.target===t.currentTarget&&f.close()}),E.addEventListener("click",t=>{t.target===t.currentTarget&&E.close()}),A.addEventListener("change",t=>{let e={};t.currentTarget.querySelectorAll('input[type="checkbox"]').forEach(t=>e[t.name]=t.checked),tA(e)}),v.addEventListener("click",t=>{let e=t.target;e.closest('[data-action="delete"]')&&window.confirm("Delete item from history?")&&j(e.closest("li").dataset.value)}),w.addEventListener("click",()=>{window.confirm("Are you sure you want to empty history?")&&F()})}()}();
//# sourceMappingURL=index.db23fba4.js.map
