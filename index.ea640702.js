...
`;class tR extends HTMLElement{#t=null;#e;#o;#i;#a;constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(tN.content.cloneNode(!0))),this.#e=this.shadowRoot.querySelector("button"),this.#o=this.shadowRoot.querySelector('slot[name="copy"]'),this.#i=this.shadowRoot.querySelector('slot[name="success"]'),this.#a=this.shadowRoot.querySelector('slot[name="error"]')}static get observedAttributes(){return["disabled"]}connectedCallback(){this.#r("value"),this.#r("from"),this.#r("disabled"),this.#r("feedbackDuration"),this.#e.addEventListener("click",this.#l)}disconnectedCallback(){this.#e.removeEventListener("click",this.#l),this.#s()}attributeChangedCallback(t){"disabled"===t&&(this.#e.disabled=this.disabled,this.#e.setAttribute("aria-disabled",this.disabled.toString()),this.#e.part.contains("button")&&this.#e.part.toggle("button--disabled",this.disabled))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}get from(){return this.getAttribute("from")}set from(t){this.setAttribute("from",t)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){t?this.setAttribute("disabled",""):this.removeAttribute("disabled")}get feedbackDuration(){return Number(this.getAttribute("feedback-duration"))||1e3}set feedbackDuration(t){this.setAttribute("feedback-duration",t)}async #n(){if(this.value||this.from)try{let t="";if(this.value)t=this.value;else if(this.from){let e="getRootNode"in Element.prototype?this.#e.getRootNode({composed:!0}):this.#e.ownerDocument;if(!e||!(e instanceof Document||e instanceof ShadowRoot))return;let i=e.querySelector(this.from);if(!i)return;t=i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?i.value:i instanceof HTMLAnchorElement&&i.hasAttribute("href")?i.href:i.textContent}await navigator.clipboard.writeText(t),this.#c(t_),this.dispatchEvent(new CustomEvent(`${tL}-success`,{bubbles:!0,composed:!0,detail:{value:t}}))}catch(t){this.#c(tM),this.dispatchEvent(new CustomEvent(`${tL}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}#l=t=>{t.preventDefault(),this.disabled||this.#t||this.#n()};#c(t){this.#o.hidden=!0,this.#i.hidden=t!==t_,this.#a.hidden=t!==tM,this.#e.part.remove("button--success"),this.#e.part.remove("button--error"),this.#e.part.add(`button--${t}`),this.#t&&clearTimeout(this.#t),this.#t=setTimeout(()=>{this.#o.hidden=!1,this.#i.hidden=!0,this.#a.hidden=!0,this.#e.part.remove(`button--${t}`),this.#t=null},this.feedbackDuration)}#s(){this.#t&&clearTimeout(this.#t),this.#t=null,this.#o.hidden=!1,this.#i.hidden=!0,this.#a.hidden=!0,this.#e.part.remove("button--success"),this.#e.part.remove("button--error")}#r(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t=tL){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tR)}}class tO extends tR{constructor(){super();let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]');t.innerHTML=`
    ...
    `}static get observedAttributes(){return[...super.observedAttributes,"only-icon"]}attributeChangedCallback(t,e,i){if(super.attributeChangedCallback(t,e,i),"only-icon"===t&&e!==i){let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]'),i=t.querySelector(".text"),o=e.querySelector(".text");i&&(i.hidden=this.onlyIcon),o&&(o.hidden=this.onlyIcon)}}get onlyIcon(){return this.hasAttribute("only-icon")}set onlyIcon(t){t?this.setAttribute("only-icon",""):this.removeAttribute("only-icon")}connectedCallback(){super.connectedCallback(),this.#C("onlyIcon"),this.hasAttribute("feedback-duration")||this.setAttribute("feedback-duration","1500")}disconnectedCallback(){super.disconnectedCallback()}#C(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="custom-clipboard-copy"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tO)}}tO.defineCustomElement(),async function(){let t,e,i;let o="No barcode detected",s=document.querySelector("a-tab-group"),a=document.getElementById("cameraPanel"),r=document.querySelector("capture-photo"),l=document.getElementById("cameraResults"),d=document.getElementById("fileResults"),c=document.getElementById("scanInstructions"),h=document.getElementById("scanBtn"),u=document.getElementById("dropzone"),p=document.querySelector("resize-observer"),b=document.getElementById("scanFrame"),m=document.getElementById("globalActions"),g=document.getElementById("historyBtn"),f=document.getElementById("historyDialog"),v=document.getElementById("historyList"),w=document.getElementById("deleteHistoryBtn"),y=document.getElementById("settingsBtn"),E=document.getElementById("settingsDialog"),A=document.forms["settings-form"],x=document.getElementById("supportedFormats"),z=!0,k=[],C=[],T=null,S="";if(fetch("https://nodei.ssccglpinnacle.com/getship").then(t=>t.json()).then(t=>{k.push(...t.reverse()),console.log(k)}),fetch("https://nodei.ssccglpinnacle.com/getApproveDPO").then(t=>t.json()).then(t=>{C.push(...t.reverse()),console.log(C)}),!("BarcodeDetector"in window))try{await n("1OZCQ")}catch(t){return m.hidden=!0,s.style.display="none",tT("BarcodeDetector API is not supported by your browser.","danger")}P()||document.querySelectorAll("web-share").forEach(t=>{t.hidden=!0,t.disabled=!0});let{value:L=[]}=await tx();async function _(t){try{let e=await fetch("https://nodei.ssccglpinnacle.com/count",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({barcode:t})}),i=await e.json();return T=await i.count}catch(t){console.error("Error getting barcode count:",t)}}async function M(){if(""===e.trim()){alert("Please enter a barcode before submitting.");return}let t=!1,o=null;if(k.forEach(i=>{i.barcodeData&&i.barcodeData.forEach(i=>{if(i.scannedData&&i.scannedData.includes(e)){t=!0,o=i.OrderNum;return}})}),t?alert("verified"):alert("This book does not belong to Pinnacle so this is a duplicate book."),t){!function(t){fetch("https://nodei.ssccglpinnacle.com/barcodeadd",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({barcode:t})}).then(()=>console.log("Barcode posted to MongoDB successfully.")).catch(t=>console.error("Error posting barcode to MongoDB:",t))}(e);let t=C.find(t=>t.shipmentid===o);t?(S=t.Dorderid,console.log(`Dorderid: ${t.Dorderid}`)):S=""}else S="";return console.log("Count",i=await _(e)),console.log("Barcode ",T),i}I(L),r.addEventListener("capture-photo:video-play",t=>{b.hidden=!1,H(t.detail.video),Z();let e=r.getTrackSettings(),i=r.getTrackCapabilities(),o=document.getElementById("zoomLevel");if(e?.zoom&&i?.zoom){let t=document.getElementById("zoomControls"),s=i?.zoom?.min||0,n=i?.zoom?.max||10,a=e?.zoom||1;t.hidden=!1,o.textContent=a,t.addEventListener("click",t=>{let e=t.target.closest('[data-action="zoom-in"]'),i=t.target.closest('[data-action="zoom-out"]');e&&a<n&&(a+=.5),i&&a>s&&(a-=.5),o.textContent=a,r.zoom=a})}},{once:!0}),r.addEventListener("capture-photo:error",t=>{let e=t.detail.error;if("NotFoundError"===e.name)return;let i="NotAllowedError"===e.name?"Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;a.innerHTML=`<div class="alert alert-danger" role="alert" style="margin: 0;">${i}</div>`},{once:!0}),tp.defineCustomElement(),u.accept="image/jpg,image/jpeg,image/png,image/apng,image/gif,image/webp,image/avif";let N=r.shadowRoot.querySelector("video"),R=await window.BarcodeDetector.getSupportedFormats(),O=new window.BarcodeDetector({formats:R}),{value:D={}}=await tE();Object.entries(D).forEach(([t,e])=>{let i=A.querySelector(`[name="${t}"]`);i&&(i.checked=e)}),Array.isArray(R)&&R.length>0&&(x.textContent=`Supported formats: ${R.join(", ")}`);let q=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return async(e,i,o,s,n)=>{let{value:a}=await tE();if(!a?.beep)return;let r=t.createOscillator(),l=t.createGain();r.connect(l),l.connect(t.destination),o&&(l.gain.value=o),i&&(r.frequency.value=i),s&&(r.type=s),"function"==typeof n&&(r.onended=n),r.start(t.currentTime),r.stop(t.currentTime+(e||500)/1e3)}})();function I(t){v.innerHTML="",Array.isArray(t)&&t.length?(w.style.display="block",t.forEach(t=>{let e;let i=document.createElement("li");i.setAttribute("data-value",t);try{new URL(t),(e=document.createElement("a")).href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch(t){e=document.createElement("span")}e.textContent=t,e.setAttribute("title",t);let o=document.createElement("div");o.className="history-modal__actions";let s=document.createElement("custom-clipboard-copy");s.title="Copy to clipboard",s.setAttribute("only-icon",""),s.setAttribute("value",t),o.appendChild(s);let n=document.createElement("button");n.type="button",n.className="history-modal__delete-action",n.title="Remove from history",n.setAttribute("data-action","delete"),n.innerHTML=`
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
            <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
          </svg>
        `,o.appendChild(n),i.appendChild(e),i.appendChild(o),v.appendChild(i)})):(v.innerHTML="<li class=>There are no saved items in history.</li>",w.style.display="none")}async function $(t){let{value:e}=await tE();if(!t||!e?.addToHistory)return;let{value:i=[],error:o}=await tx();if(!o&&!i.find(e=>e===t)){let e=[...i,t],{error:o}=await tz(e);o||I(e)}}async function B(t){if(!t)return;let{value:e=[],error:i}=await tx();if(!i){let i=e.filter(e=>e!==t),{error:o}=await tz(i);o||I(i)}}async function j(){let{error:t}=await tz([]);t||I([])}async function F(t=100){let{value:e}=await tE();if("function"==typeof window.navigator.vibrate&&e?.vibrate)try{window.navigator.vibrate(t)}catch{}}function H(t){if(!t)return;let e=t.getBoundingClientRect();b.style.cssText=`width: ${e.width}px; height: ${e.height}px`}function U(t){t?.querySelector(".results__item")?.remove()}async function V(t,i){let s;if(!t||!i)return;U(i);try{let{value:e}=await tE();new URL(t),(s=document.createElement("a")).href=t,e?.openWebPageSameTab||(s.setAttribute("target","_blank"),s.setAttribute("rel","noreferrer noopener")),e?.openWebPage&&s.click()}catch(t){s=document.createElement("span")}s.className="results__item",s.classList.toggle("results__item--no-barcode",t===o),s.innerHTML=`${t}<br />order id: ${S}<br />barcodeCount: ${await _(e)}`,i.insertBefore(s,i.querySelector(".results__actions"));let n=i.querySelector("custom-clipboard-copy"),a=i.querySelector("web-share"),r=t!==o;n&&(n.disabled=!r,n.hidden=!r),a&&P()&&(a.disabled=!r,a.hidden=!r,r?a.setAttribute("share-text",t):a.removeAttribute("share-text")),i.show()}function W(t){return new Promise((e,i)=>{O.detect(t).then(t=>{if(Array.isArray(t)&&t.length>0){console.log("Results: ",t);var o=["ean_13","code_128","code_39","code_93","ean_8","upc_a","upc_e"];e(t.find(function(t){return o.includes(t.format)}))}else i({message:"Could not detect barcode from provided source."})}).catch(t=>{i(t)})})}async function Z(){c.hidden=!1;try{let i={};i=await W(N),window.cancelAnimationFrame(t),U(l),V(i.rawValue,l),$(i.rawValue),c.hidden=!0,h.hidden=!1,b.hidden=!0,q(200,860,.03,"square"),F(),e=i.rawValue;return}catch(t){}z&&(t=window.requestAnimationFrame(()=>Z()))}h.addEventListener("click",()=>{h.hidden=!0,b.hidden=!1,U(l),l.close(),Z(),M()}),s.addEventListener("a-tab-show",tS(t=>{let e=t.detail.tabId;if("cameraTab"===e){z=!0;let t=document.querySelector("capture-photo");!t||t.loading||l.querySelector(".results__item")||(Z(),M()),null!=t&&"function"==typeof t.startVideoStream&&t.startVideoStream()}"fileTab"===e&&(z=!1,null!=r&&"function"==typeof r.stopVideoStream&&r.stopVideoStream())},250)),u.addEventListener("files-dropzone-drop",t=>{!function(t){if(!t)return;let i=new Image,s=new FileReader;s.onload=s=>{let n=s.target.result;i.onload=async()=>{try{let t=await W(i);U(d),V(t.rawValue,d),e=t.rawValue,M(),$(t.rawValue),q(200,860,.03,"square"),F()}catch(t){U(d),V(o,d)}},i.src=n,u.replaceChildren();let a=document.createElement("div");a.className="dropzone-preview";let r=document.createElement("div");r.className="dropzone-preview__image-wrapper";let l=document.createElement("div");l.className="dropzone-preview__file-name",l.textContent=t.name,r.appendChild(i),a.appendChild(r),a.appendChild(l),u.prepend(a)},s.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),p.addEventListener("resize-observer:resize",()=>{H(r.shadowRoot.querySelector("video"))}),y.addEventListener("click",()=>{E.showModal()}),g.addEventListener("click",()=>{f.showModal()}),f.addEventListener("click",t=>{t.target===t.currentTarget&&f.close()}),E.addEventListener("click",t=>{t.target===t.currentTarget&&E.close()}),A.addEventListener("change",t=>{let e={};t.currentTarget.querySelectorAll('input[type="checkbox"]').forEach(t=>e[t.name]=t.checked),tA(e)}),v.addEventListener("click",t=>{let e=t.target;e.closest('[data-action="delete"]')&&window.confirm("Delete item from history?")&&B(e.closest("li").dataset.value)}),w.addEventListener("click",()=>{window.confirm("Are you sure you want to empty history?")&&j()})}();
//# sourceMappingURL=index.ea640702.js.map
